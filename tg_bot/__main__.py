...
Join my [news channel](https://t.me/xenpaicc) to get information on all the latest updates.
"""
...
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "If you have any bugs or questions on how to use me, have a look at my [Group](https://t.me/xenpaicc, or head to @xenpaicc.")

DONATE_STRING = """Heya, glad to hear you want to donate!
It took lots of work for [my creator](t.me/xenpai) to get me to where I am now, and every donation helps \
